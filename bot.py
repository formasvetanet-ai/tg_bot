...
SUPPLIER_QUESTIONS = [
    ...
    "4️⃣ Какой бюджет на закупку? (если не знаете — напишите «не определён» или пропустите)",
...
DELIVERY_QUESTIONS = [
    ...
    "6️⃣ Объём груза в м³ (введите число, например: 2.5):",
    "7️⃣ Вес груза в кг (введите число, например: 300):",
